...
Usage::
    ...
    from energy_pipeline.mcp_servers.registry import list_servers, get_server
...
_MCP_SERVERS: dict[str, dict[str, Any]] = {
    "pybamm_mcp": {
        "module": "energy_pipeline.mcp_servers.pybamm_mcp",
    ...
    "pvlib_mcp": {
        "module": "energy_pipeline.mcp_servers.pvlib_mcp",
    ...
    "solcore_mcp": {
        "module": "energy_pipeline.mcp_servers.solcore_mcp",
        "tools": ["iv_curve"],
        "license_class": "B",
        "sub_vertical": "electrochemistry",
        "layer": "L4",
    ...
    "cantera_mcp": {
        "module": "energy_pipeline.mcp_servers.cantera_mcp",
    ...
    "pypsa_mcp": {
        "module": "energy_pipeline.mcp_servers.pypsa_mcp",
        "tools": ["lcoe"],
        "license_class": "A",
        "sub_vertical": "electrochemistry",
        "layer": "L5",
    ...
    "pysam_mcp": {
        "module": "energy_pipeline.mcp_servers.pysam_mcp",
    ...
    "openmc_mcp": {
        "module": "energy_pipeline.mcp_servers.openmc_mcp",
    ...
    "imas_codex_mcp": {
        "module": "energy_pipeline.mcp_servers.imas_codex_mcp",
        "tools": ["read_ids"],
        "license_class": "B",
        "sub_vertical": "fusion",
        "layer": "L4",
    ...
    "aiida_mcp": {
        "module": "energy_pipeline.mcp_servers.aiida_mcp",
        "tools": ["submit_dryrun"],
        "license_class": "A",
        "sub_vertical": "electrochemistry",
        "layer": "L5",
