...
from energy_physics_pipeline.boundary import BoundaryViolation, verify_boundary
from energy_physics_pipeline.schemas.canonical import canonical_json, sha256_of
...
def _project_root() -> Path:
    ...
    # energy_physics_pipeline/audit/writer.py -> repo root is parents[2]
