...
from energy_physics_pipeline.schemas.envelope import FailureRecord, FalsificationBlock
...
def stub_scientific_valid_falsifier(env: UniversalLayerEnvelope) -> list[FailureRecord] | None:
    from energy_physics_pipeline.schemas.envelope import ExecutionMode, Mode
...
def license_promotion_falsifier(env: UniversalLayerEnvelope) -> list[FailureRecord] | None:
    from energy_physics_pipeline.schemas.envelope import LicenseClass, Mode
