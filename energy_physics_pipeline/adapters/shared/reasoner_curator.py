...
from energy_physics_pipeline.schemas.reasoner import OutcomeLabel, ReasonerTuple, RightsLabel
from energy_physics_pipeline.schemas.envelope import UniversalLayerEnvelope, Mode
...
def build_tuple_from_run(
    ...
    """Build a :class:`~energy_physics_pipeline.schemas.reasoner.ReasonerTuple` from a pipeline run.
...
def write_to_kg(tuple_obj: ReasonerTuple, kg: Any) -> str:
    ...
    Args:
        ...
        kg: A :class:`~energy_physics_pipeline.kg.graph.KGStore` instance.
