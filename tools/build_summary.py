...
def main() -> int:
    ...
    # Adapters
    ec_dir = ROOT / "energy_physics_pipeline" / "adapters" / "electrochem"
    fu_dir = ROOT / "energy_physics_pipeline" / "adapters" / "fusion"
    sh_dir = ROOT / "energy_physics_pipeline" / "adapters" / "shared"
    print("## Adapters")
    ...
    # MCP servers
    mcp_dir = ROOT / "energy_physics_pipeline" / "mcp_servers"
    print("## MCP servers")
    print(f"- Modules: {list_modules(mcp_dir)}")
    print()

    # TDA
    tda_dir = ROOT / "energy_physics_pipeline" / "tda"
    print("## TDA")
